            ...
            <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8'>
                <div className='md:w-10/12 mx-auto flex flex-col lg:flex-row justify-between items-center gap-12'>
                    ...
                    <div className=''>
                        ...
                        <button className='btn bg-orange-500 hover:bg-pink-500 text-white py-2 px-6 rounded-full text-lg hover:transition duration-300 ease-out'>View More</button>
                    </div>
                </div>
            </div>
        </div>
